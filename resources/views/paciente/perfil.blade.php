...
<div style="max-width: 800px; margin: 0 auto;">
    <div class="page-header" style="background: linear-gradient(135deg, #764ba2 0%, #667eea 100%);">
    ...
    <div style="background: white; border-radius: 16px; padding: 24px; box-shadow: 0 4px 20px rgba(0,0,0,0.06);">
        ...
        <form method="POST" action="{{ route('paciente.password') }}">
            ...
            <button type="submit" style="padding: 10px 24px; background: linear-gradient(135deg, #667eea, #764ba2); color: white; border: none; border-radius: 10px; font-weight: 600; cursor: pointer;">Actualizar Contraseña</button>
        </form>
    </div>
</div>
@endsection
