<div id="modalNino" class="modal-paciente" style="display: none;">
    <div class="modal-paciente-box" style="max-width: 800px;">
        <div class="modal-paciente-header" style="background: linear-gradient(135deg, #10b981, #059669);">
            <h2><i class="fas fa-child"></i> Registrar Paciente Niño</h2>
            <button class="modal-paciente-close" onclick="cerrarModal('niño')">×</button>
        </div>
        ...
        <div style="padding: 15px 25px; background: #f8fafc; border-bottom: 1px solid #e2e8f0;">
            <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                ...
                <span style="font-size: 12px; color: #64748b;" id="stepTitleNino">Datos Básicos</span>
            </div>
        ...
        <form action="{{ route('pacientes.store') }}" method="POST" id="formNino" onsubmit="return validarFormNino()">
            @csrf
            <input type="hidden" name="tipo_paciente" value="niño">
            
            <div class="modal-paciente-body">
                
                {{-- PASO 1: DATOS BÁSICOS --}}
                <div class="stepNino" id="stepNino1">
                    <h4 style="color: #2d3748; margin-bottom: 15px; font-size: 16px;"><i class="fas fa-info-circle" style="color: #10b981;"></i> Datos Básicos</h4>
                    <div class="grid-form">
                        ...
                        <div class="field">
                            ...
                            <span class="text-muted" style="font-size: 11px; color: #64748b;">Edad máxima: 11 años</span>
                        </div>
                        <div class="field">
                        ...
                        <div class="field"><label>Grado de Instrucción</label><input type="text" name="grado_instruccion" class="input-field" placeholder="Ej: Primaria 2do grado"></div>
                        <div class="field"><label>Maestro</label><input type="text" name="maestro" class="input-field" placeholder="Nombre del maestro"></div>
                        <div class="field full-width"><label>Dirección</label><input type="text" name="direccion" class="input-field" placeholder="Dirección completa"></div>
                    </div>
                </div>
                ...
                <div class="stepNino" id="stepNino2" style="display: none;">
                    ...
                    <div class="grid-form">
                        ...
                        <div class="field full-width"><label>Ocupación del Padre</label><input type="text" name="ocupacion_padre" class="input-field"></div>
                        ...
                        <div class="field full-width"><label>Ocupación de la Madre</label><input type="text" name="ocupacion_madre" class="input-field"></div>
                        <div class="field"><label>Hermanos (edades)</label><input type="text" name="hermanos" class="input-field" placeholder="Ej: Juan 8, María 5"></div>
                ...
                <div class="stepNino" id="stepNino3" style="display: none;">
                    ...
                    <div class="grid-form">
                        ...
                        <div class="field full-width"><label>Desarrollo del problema</label><textarea name="desarrollo_problema" class="input-field" rows="2" placeholder="¿Cómo se ha desarrollado el problema?"></textarea></div>
                        <div class="field">
                        ...
                        <div class="field"><label>Duración</label><input type="text" name="duracion_sintomas" class="input-field" placeholder="Ej: 3 meses, 1 año"></div>
                        <div class="field"><label>Contexto</label><input type="text" name="contexto_problema" class="input-field" placeholder="¿Dónde y cuándo ocurre?"></div>
                        <div class="field full-width"><label>Estrategias de afrontamiento</label><textarea name="estrategias_afrontamiento" class="input-field" rows="2" placeholder="¿Qué han intentado?"></textarea></div>
                        <div class="field full-width"><label>Consecuencias</label><input type="text" name="consecuencias" class="input-field" placeholder="¿Por qué creen que ocurre?"></div>
                ...
                <div class="stepNino" id="stepNino4" style="display: none;">
                    ...
                    <div class="grid-form">
                        <div class="field">
                            ...
                            <select name="tipo_parto" class="input-field"><option value="">Seleccione...</option><option>Natural</option><option>Cesárea</option><option>Inducido</option></select>
                        </div>
                        ...
                        <div class="field full-width"><label>Comportamiento del bebé</label><input type="text" name="comportamiento_bebe" class="input-field" placeholder="Sueño, llanto, alimentación"></div>
                        <div class="field full-width"><label>Reacciones ante estímulos</label><input type="text" name="reacciones_estimulos" class="input-field"></div>
                        <div class="field full-width"><label>Situación familiar postnatal</label><input type="text" name="situacion_familiar_postnatal" class="input-field"></div>
                        <div class="field full-width"><label>Aceptación maternidad</label><textarea name="aceptacion_maternidad" class="input-field" rows="2"></textarea></div>
                    </div>
                </div>
                ...
                <div class="stepNino" id="stepNino5" style="display: none;">
                    ...
                    <div class="grid-form">
                        <div class="field full-width"><label>Desarrollo en diferentes áreas</label><textarea name="desarrollo_areas" class="input-field" rows="2"></textarea></div>
                        ...
                        <div class="field full-width"><label>Alimentación del bebé</label><input type="text" name="alimentacion_bebe" class="input-field"></div>
                        ...
                        <div class="field full-width"><label>Trastornos alimentación</label><input type="text" name="trastornos_alimentacion" class="input-field" placeholder="Vómitos, diarreas..."></div>
                        <div class="field full-width"><label>Alimentación actual</label><textarea name="alimentacion_actual" class="input-field" rows="2"></textarea></div>
                        <div class="field full-width"><label>Descripción día anterior</label><textarea name="descripcion_dia_anterior" class="input-field" rows="2"></textarea></div>
                        ...
                        <div class="field full-width"><label>Desarrollo sexual actual</label><input type="text" name="desarrollo_sexual" class="input-field" placeholder="Descripción acorde a la edad"></div>
                    </div>
                </div>
                
                {{-- PASO 6: ÁREA ESCOLAR Y CONDUCTUAL --}}
                <div class="stepNino" id="stepNino6" style="display: none;">
                    <h4 style="color: #2d3748; margin-bottom: 15px; font-size: 16px;"><i class="fas fa-school" style="color: #10b981;"></i> Área Escolar y Conductual</h4>
                    <div class="grid-form">
                        <div class="field full-width"><label>Tareas escolares</label><textarea name="tareas_escolares" class="input-field" rows="2" placeholder="Intervención padres, dificultades"></textarea></div>
                        ...
                        <div class="field full-width"><label>Responsabilidades domésticas</label><input type="text" name="responsabilidades_domesticas" class="input-field"></div>
                        ...
                        <div class="field">
                            ...
                            <select name="finalizacion_tareas" class="input-field"><option value="">Seleccione...</option><option>Sí, siempre</option><option>A veces</option><option>No</option></select>
                        </div>
                        <div class="field full-width"><label>Arrebatos</label><textarea name="arrebatos" class="input-field" rows="2" placeholder="Cómo se enoja y reacciona"></textarea></div>
                        ...
                        <div class="field full-width"><label>Agresiones</label><textarea name="agresiones" class="input-field" rows="2" placeholder="Cómo resuelve conflictos"></textarea></div>
                    </div>
                </div>
                ...
                <div class="stepNino" id="stepNino7" style="display: none;">
                    ...
                    <div class="grid-form">
                        <div class="field full-width"><label>Autoimagen</label><textarea name="autoimagen" class="input-field" rows="2" placeholder="Cómo se ve a sí mismo"></textarea></div>
                        <div class="field full-width"><label>Percepción de los demás</label><textarea name="percepcion_demas" class="input-field" rows="2"></textarea></div>
                        <div class="field full-width"><label>Relaciones con niños</label><textarea name="relaciones_ninos" class="input-field" rows="2" placeholder="Con compañeros"></textarea></div>
                        <div class="field">
                            <label>¿Tiene amigos?</label>
                            <select name="tiene_amigos" class="input-field"><option value="">Seleccione...</option><option>Sí</option><option>No</option><option>Pocos</option></select>
                        </div>
                        <div class="field"><label>Actividades sociales</label><input type="text" name="actividades_sociales" class="input-field"></div>
                        <div class="field full-width"><label>Tipo de niños que le atraen</label><input type="text" name="tipo_ninos_atraen" class="input-field"></div>
                        ...
                        <div class="field full-width"><label>Relación con adultos</label><textarea name="relacion_adultos" class="input-field" rows="2"></textarea></div>
                    ...
                    <div style="margin-top: 20px; padding: 20px; background: #ecfdf5; border-radius: 12px; border: 1px solid #a7f3d0;">
                        ...
                        <p style="margin: 0; color: #047857; font-size: 13px;">Al guardar, se creará el expediente del paciente niño.</p>
                    </div>
                </div>
            ...
            <div class="modal-paciente-footer" style="justify-content: space-between;">
                ...
                <div>
                    <button type="button" class="btn-paciente btn-paciente-cancel" onclick="cerrarModal('niño')" style="margin-right: 8px;">Cancelar</button>
