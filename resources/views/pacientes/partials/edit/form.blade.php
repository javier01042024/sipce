            ...
            <form action="{{ route('pacientes.update', $paciente) }}" method="POST" id="formEditPaciente" onsubmit="return validarFormEdit()">
                ...
                <div id="commonFields">
                    <h4 style="color: #2d3748; margin-bottom: 15px; font-size: 16px;">
                        <i class="fas fa-clipboard-list" style="color: #667eea;"></i> Datos de la Consulta
                    </h4>
                    <div class="grid-form">
                        <div class="field">
                ...
                <div id="adultoFields">
                    <h4 style="color: #2d3748; margin: 25px 0 15px; font-size: 16px;">
                        <i class="fas fa-id-card" style="color: #667eea;"></i> Datos Personales
                    </h4>
                    <div class="grid-form">
                    ...
                    <h4 style="color: #2d3748; margin: 25px 0 15px; font-size: 16px;"><i class="fas fa-briefcase" style="color: #667eea;"></i> Datos Laborales</h4>
                    <div class="grid-form">
                    ...
                    <h4 style="color: #2d3748; margin: 25px 0 15px; font-size: 16px;"><i class="fas fa-phone-alt" style="color: #667eea;"></i> Contacto de Emergencia</h4>
                    <div class="grid-form">
                    ...
                    <h4 style="color: #2d3748; margin: 25px 0 15px; font-size: 16px;"><i class="fas fa-clipboard-list" style="color: #667eea;"></i> Motivo de Consulta</h4>
                    <div class="grid-form">
                    ...
                    <h4 style="color: #2d3748; margin: 25px 0 15px; font-size: 16px;"><i class="fas fa-home" style="color: #667eea;"></i> Historia Familiar y Social</h4>
                    <div class="grid-form">
                    ...
                    <h4 style="color: #2d3748; margin: 25px 0 15px; font-size: 16px;"><i class="fas fa-venus-mars" style="color: #667eea;"></i> Vida Sexual</h4>
                    <div class="grid-form">
                    ...
                    <h4 style="color: #2d3748; margin: 25px 0 15px; font-size: 16px;"><i class="fas fa-brain" style="color: #667eea;"></i> Evaluación Emocional y Conductual</h4>
                    <div class="grid-form">
                    ...
                    <h4 style="color: #2d3748; margin: 25px 0 15px; font-size: 16px;"><i class="fas fa-history" style="color: #667eea;"></i> Antecedentes</h4>
                    <div class="grid-form">
                    ...
                    <h4 style="color: #2d3748; margin: 25px 0 15px; font-size: 16px;"><i class="fas fa-star" style="color: #667eea;"></i> Recursos y Fortalezas</h4>
                    <div class="grid-form">
