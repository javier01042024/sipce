...
.user-detail-show .fecha-display {
    font-size: 14px;
...
.emocion-badge-large.positivo {
    background: rgba(255, 255, 255, 0.2);
    border: 1px solid rgba(255, 255, 255, 0.3);
}

.emocion-badge-large.neutral {
    background: rgba(255, 255, 255, 0.2);
    border: 1px solid rgba(255, 255, 255, 0.3);
}

.emocion-badge-large.negativo {
    background: rgba(255, 255, 255, 0.2);
    border: 1px solid rgba(255, 255, 255, 0.3);
}
...
.metadata-icon.created {
    background: #eff6ff;
    color: #3b82f6;
}

.metadata-icon.updated {
    background: #fef3c7;
    color: #f59e0b;
}
...
.btn-accion.volver-listado {
    background: #f1f5f9;
    color: #475569;
}

.btn-accion.volver-listado:hover {
    background: #e2e8f0;
    transform: translateY(-2px);
}
...
var diarioId = {!! json_encode($diario->id) !!};
var diarioFecha = {!! json_encode(\Carbon\Carbon::parse($diario->fecha)->format('d/m/Y')) !!};
var deleteUrl = {!! json_encode(route('diarios.destroy', $diario)) !!};
var indexUrl = {!! json_encode(route('diarios.index')) !!};
